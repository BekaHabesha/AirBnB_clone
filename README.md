...
| **6** | [**help**](./console.py) | **help<br>< topic >** | **Prints information<br>about specific command** | **((hbnb) help<br><br>Documented commands (type help <topic>):<br>========================================<br>EOF  all  count  create  destroy  help  quit  show  update<br><br>(hbnb)** |
